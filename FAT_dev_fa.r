...
##covariates
ind_cov = c(which(names(dat)=="sex"), which(names(dat)=="dti_wholebrain_fa.mean"), which(names(dat)=="directions_kept"))
...
ind_dv = c(which(names(dat)=="lpresma_op_fa.mean"),which(names(dat)=="lpresma_tri_fa.mean"),which(names(dat)=="lsma_op_fa.mean"),which(names(dat)=="lsma_tri_fa.mean"),which(names(dat)=="rpresma_op_fa.mean"),which(names(dat)=="rpresma_tri_fa.mean"),which(names(dat)=="rsma_op_fa.mean"),which(names(dat)=="rsma_tri_fa.mean"))
...
write.table(m1,file="/Users/dgaric/Google\ Drive/Dissertation/Results/Tables/Development/FAT_dev_FA.txt")
